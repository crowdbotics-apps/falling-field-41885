"""
Django settings for falling_field_41885 project.
...
ROOT_URLCONF = 'falling_field_41885.urls'
...
WSGI_APPLICATION = 'falling_field_41885.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_field_41885 API",
    "DESCRIPTION": "API documentation for falling_field_41885 App",
    "VERSION": "v1",
}
